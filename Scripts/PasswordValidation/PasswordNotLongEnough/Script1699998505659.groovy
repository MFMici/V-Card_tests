...
WebUI.setText(findTestObject('Object Repository/Page_Vite  Vue/input_Phone_phone'), '917 583 241')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Vite  Vue/input_Password_password'), 'KPTvxy6UfMg=')

WebUI.click(findTestObject('Page_Vite  Vue/li_Password must be at least 8 characters long'))
